    ...
    <form id="contact-form"
        ...
        <div class="form-group">
            <input type="text" placeholder="Tu nombre..."
                   ...
                   @error('name_mess')
                          style="border: 1px solid #f35353"
                        @else
                          style="border: 1px solid #57cbcc"
                    @enderror
        ...
        <div class="form-group">
            <input type="email" placeholder="Tu Email..." 
                   ...
                   id="email" wire:model="email_mess">
        ...
        <div class="form-group">
            <textarea rows="6" placeholder="Puedes escribir hasta 200 caracteres..." 
                      class="form-control"
                      @error('message')
                          style="border: 1px solid #f35353"
                        @else
        ...
        <div id="cf-submit">
            <input type="button" id="contact-submit" class="btn btn-transparent" value="Enviar"
            wire:click="store"
            >
